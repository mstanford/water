...
{
	public class SqlNode : System.IComparable
	{
		public int Type;
		public string Value;
		public System.Collections.Generic.List<SqlNode> Nodes = new System.Collections.Generic.List<SqlNode>();

		public SqlNode(int type)
		{
			Type = type;
		}

		public SqlNode(int type, string value)
		{
			Type = type;
			Value = value;
		}
